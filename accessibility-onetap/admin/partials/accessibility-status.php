...
$accessibility_status = array(
	'onetap_show_accessibility'    => get_option( 'onetap_show_accessibility' ),
	'onetap_select_language'       => get_option( 'onetap_select_language' ),
	'onetap_company_name'          => get_option( 'onetap_company_name' ),
	'onetap_company_website'       => get_option( 'onetap_company_website' ),
	'onetap_business_email'        => get_option( 'onetap_business_email' ),
	'onetap_confirmation_checkbox' => get_option( 'onetap_confirmation_checkbox' ),
	'onetap_editor_generator'      => get_option( 'onetap_editor_generator' ),
);
?>
...
<div class="wrap">
	...
	<header class="top">
		<div class="mycontainer">
			...
			<div class="myrow myrow2">
				<h2><?php esc_html_e( 'Generate Accessibility Status', 'accessibility-onetap' ); ?></h2>
				<p class="desc"><?php esc_html_e( 'Enter your data to instantly generate your personal accessibility status. Display it directly in the OneTap Toolbar – for ', 'accessibility-onetap' ); ?>
					<br>
					<?php esc_html_e( 'more transparency, inclusion, and digital accessibility at a glance.', 'accessibility-onetap' ); ?>
				</p>
			</div>
		</div>
	</header>
	<form method="post" action="options.php" class="accessibility-status">
		...
		<div class="container accessibility-status-container">
			<!-- Left column -->
			<div class="left-column">
				<!-- Show Accessibility Statement -->
				<div class="box-control-toggle custom-box-controls">
					<label class="switch" for="show-accessibility-statement">
						<input type="checkbox" class="checkbox" id="show-accessibility-statement" name="onetap_show_accessibility" value="1" <?php checked( 1, $accessibility_status['onetap_show_accessibility'] ); ?> />
				...
				<div class="dropdown-box-control custom-box-controls">
					<label for="onetap_select_language"><?php esc_html_e( 'Select Language', 'accessibility-onetap' ); ?></label>
					<select id="onetap_select_language" name="onetap_select_language">
						<?php
						$languages = array(
						...
						foreach ( $languages as $code => $label ) {
							printf(
								...
								esc_attr( $code ),
								selected( $accessibility_status['onetap_select_language'], $code, false ),
								esc_html( $label )
							);
						}
						?>
				...
				<!-- Company Name -->
				<div class="text-box-control custom-box-controls">
					<label for="onetap_company_name"><?php esc_html_e( 'Company Name', 'accessibility-onetap' ); ?></label>
					<input type="text" id="onetap_company_name" name="onetap_company_name" value="<?php echo esc_attr( $accessibility_status['onetap_company_name'] ); ?>" placeholder="<?php echo esc_attr__( 'Company Inc.', 'accessibility-onetap' ); ?>" />
				</div>

				<!-- Company Website -->
				<div class="text-box-control custom-box-controls">
					<label for="onetap_company_name"><?php esc_html_e( 'Company Website', 'accessibility-onetap' ); ?></label>
					<input type="text" id="onetap_company_website" name="onetap_company_website" value="<?php echo esc_url( $accessibility_status['onetap_company_website'] ); ?>" placeholder="<?php echo esc_attr__( 'www.company.com', 'accessibility-onetap' ); ?>" />
				</div>

				<!-- Business Email -->
				<div class="email-box-control custom-box-controls">
					<label for="onetap_company_name"><?php esc_html_e( 'Business Email', 'accessibility-onetap' ); ?></label>
					<input type="email" id="onetap_business_email" name="onetap_business_email" value="<?php echo esc_attr( $accessibility_status['onetap_business_email'] ); ?>" placeholder="<?php echo esc_attr__( 'info@company.com', 'accessibility-onetap' ); ?>" />
				</div>

				<!-- Confirmation Checkbox -->
				<div class="checkbox-box-control custom-box-controls" style="margin: 0;">
					<label style="margin-bottom: 10px; font-size: 12px;">
						<input type="checkbox" name="onetap_confirmation_checkbox" value="1" <?php checked( 1, $accessibility_status['onetap_confirmation_checkbox'] ); ?>>
				...
				<button class="save-changes left-column generate-accessibility-statement"><?php esc_html_e( 'Generate Text', 'accessibility-onetap' ); ?></button>

				<button class="save-changes left-column only-save-changes"><?php esc_html_e( 'Save Settings', 'accessibility-onetap' ); ?></button>
			...
			<div class="right-column">
				...
				<div class="readmore">
					<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
						<path d="M11.34 2.281C7.073 2.553 3.439 5.66 2.499 9.84a10.086 10.086 0 0 0 0 4.32 9.76 9.76 0 0 0 7.341 7.341c1.393.313 2.93.312 4.336-.003 3.289-.739 5.985-3.188 7.068-6.422a9.928 9.928 0 0 0 .257-5.236 9.76 9.76 0 0 0-7.341-7.341 10.445 10.445 0 0 0-2.82-.218m1.621 1.521a8.318 8.318 0 0 1 5.894 3.608c.543.802 1.034 1.968 1.222 2.899.124.611.163 1.019.163 1.691 0 1.332-.263 2.465-.845 3.642a8.146 8.146 0 0 1-3.753 3.753c-1.177.582-2.31.845-3.642.845a7.867 7.867 0 0 1-3.626-.836 8.266 8.266 0 0 1-4.572-6.443c-.054-.436-.054-1.486 0-1.922.195-1.582.857-3.123 1.846-4.299.337-.4.751-.811 1.168-1.159 1.084-.904 2.682-1.585 4.168-1.775.395-.051 1.579-.053 1.977-.004m-1.434 3.489c-.193.062-.507.36-.587.559-.097.24-.091.612.013.817.178.349.448.533.827.563a.965.965 0 0 0 .804-.319.864.864 0 0 0 .256-.662c0-.676-.669-1.164-1.313-.958m-.924 3.298c-.246.127-.303.25-.303.651 0 .295.014.372.082.465.168.224.271.269.658.288l.36.017v2.75h-.312c-.583 0-.821.214-.821.74 0 .362.082.523.332.65.174.088.206.09 1.557.09 1.32 0 1.386-.004 1.553-.084.234-.114.331-.305.331-.656 0-.525-.236-.74-.81-.74h-.305l-.013-1.89c-.011-1.806-.016-1.896-.092-2.026a.88.88 0 0 0-.193-.22c-.105-.079-.17-.085-1-.095-.785-.01-.903-.003-1.024.06" fill-rule="evenodd"></path>
					</svg>
					<span>
						...
						<a href="https://wponetap.com/tutorial/accessibility-statement-generator/" target="_blank"><?php esc_html_e( 'Read More', 'accessibility-onetap' ); ?>→</a>
					</span>
				</div>
				...
				<div class="editor">
					...
					wp_editor(
						wp_kses_post( $accessibility_status['onetap_editor_generator'] ),
						'onetap_editor_generator',
						$editor_settings
					);
					?>
					<span style="display: none;" class="copy" data-default-text="<?php esc_html_e( 'Copy', 'accessibility-onetap' ); ?>" data-copied-text="<?php esc_html_e( 'Copied', 'accessibility-onetap' ); ?>!">
						...
						<span class="copy-text"><?php esc_html_e( 'Copy', 'accessibility-onetap' ); ?></span>
					</span>
				</div>
			</div>
		</div>
